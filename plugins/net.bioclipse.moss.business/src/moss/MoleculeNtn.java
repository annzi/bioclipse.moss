...
public void setEdgeMgr (TypeMgr edgemgr)
  ...
  {                             /* --- get (and mark) hydrogens */
    ...
    for (i = atom.deg; --i >= 0; ) {
      ...
      d = (e.src != atom) ? e.src : e.dst;
      t = (coder != null) ? coder.decode(d.type) : d.type;
      if ((d.deg != 1)  || (Atoms.getElem(t)      != Atoms.HYDROGEN))
        continue;               /* skip non-terminals/non-hydrogens */
      e.mark = 0; d.mark = -1;  /* mark bond and atom as processed */

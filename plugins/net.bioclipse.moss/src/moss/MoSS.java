...
public class MoSS extends JFrame
  ...
  /** the name of the molecule identifier file */
  ...
  /*------------------------------------------------------------------*/
  /** the maximal number of embeddings per molecule */
  ...
  {                             /* --- create toolbox dialog */
    ...
    tab.addHelp("In order to speed up extensions each fragment "
               ...
               +"of the database.\nRestricting the maximal number of "
               +"embeddings that are\nkept per graph can reduce the "
    ...
    tab.addHelp("If canonical form pruning is deactivated, "
  ...
  {                             /* --- load configuration */
    ...
    try {                       /* open the configuration file */
      ...
      this.maxemb.setValue (new Integer(this.readInt(reader)));
  ...
  {                             /* --- save configuration */
    ...
    try {                       /* open the configuration file */
      ...
      writer.write(((Integer)this.maxemb.getValue()).intValue()  +",");

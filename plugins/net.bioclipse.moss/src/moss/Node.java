...
/*----------------------------------------------------------------------
  File    : Node.java
  Contents: class for nodes for attributed (labeled/typed) graphs
...
public class Node implements Comparable {
  ...
  /** the mask for special node flags/types (chain and wildcard) */
  public static final int SPECIAL  = ~TYPEMASK;
  ...
  public static final int CHAIN    = Integer.MAX_VALUE & SPECIAL;
  ...
  /*  instance variables                                              */
  /*------------------------------------------------------------------*/
  /** the type (attribute/label) of a node */
  protected int    type;
    ...
    if (this.deg > 12) {        /* if not very few edges to sort */
      Arrays.sort(this.edges, 0, this.deg, new Comparator () {
        public int compare (Object o1, Object o2) {
          Edge e1 = (Edge)o1;   /* use the generic sorting function */
          Edge e2 = (Edge)o2;   /* with a special Comparator object */
